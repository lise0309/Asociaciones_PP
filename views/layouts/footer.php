      ...
      <div class="footer-grid">
        ...
        <div class="footer-brand">
          <a href="#" class="footer-logo-link">
            ...
            <img src="/Asociaciones_PP/assets/img/logo_PP_negativo.png" alt="PP Bienes Raíces" class="footer-logo-img">
          </a>
          <p class="footer-desc">
        ...
        <div class="footer-col">
          ...
          <ul class="footer-contact-list">
            <li>
              <span class="fc-label">Dirección</span>
              <span class="fc-val">San Salvador, El Salvador</span>
            </li>
            <li>
              <span class="fc-label">Teléfono</span>
              <a href="tel:+50322223333" class="fc-val fc-link">+503 2222-3333</a>
            </li>
            <li>
              <span class="fc-label">Correo</span>
              <a href="mailto:info@ppbienesraices.sv" class="fc-val fc-link">info@ppbienesraices.sv</a>
            </li>
            <li>
              <span class="fc-label">Horario</span>
              <span class="fc-val">Lun – Vie: 8:00am – 5:00pm</span>
            </li>
          </ul>
        </div>
  ...
  <div class="footer-bottom">
    <div class="footer-container">
      <div class="footer-bottom-inner">
        <p class="footer-copy">
          &copy; <?= date('Y') ?> <strong>Asociaciones Portillo Pocasangre</strong>. Todos los derechos reservados.
        </p>
