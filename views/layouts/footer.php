<?php
/**
 * FOOTER - Versión Premium con secciones minimalistas
 * ProyectoMira — views/layouts/footer.php
 */
?>
    ...
    <div class="container">
      <div class="footer-grid">
        ...
        <div class="footer-brand">
          ...
          <p class="footer-desc">
            La plataforma de bienes raíces más completa de El Salvador. Conectamos compradores y arrendatarios con vendedores verificados en los 14 departamentos del país.
          </p>
        ...
        <!-- ── Propiedades (Minimalista + Estático) ── -->
        <div class="footer-col footer-col-minimal">
          <h4>Propiedades</h4>
          <ul class="footer-nav-minimal">
            <li><a href="views/propiedades/listado.php?tipo=casa">Casas en venta</a></li>
            <li><a href="views/propiedades/listado.php?tipo=apartamento">Apartamentos</a></li>
            <li><a href="views/propiedades/listado.php?tipo=terreno">Terrenos</a></li>
            <li><a href="views/propiedades/listado.php?tipo=local">Locales comerciales</a></li>
            <li><a href="views/propiedades/listado.php?tipo=bodega">Bodegas</a></li>
            <li><a href="views/propiedades/listado.php?negocio=alquiler">En alquiler</a></li>
            <li><a href="views/propiedades/listado.php?negocio=opcion">Alquiler c/ opción</a></li>
          </ul>
        </div>

        <!-- ── Sistema (Minimalista + Estático) ── -->
        <div class="footer-col footer-col-minimal">
          <h4>Sistema</h4>
          <ul class="footer-nav-minimal">
            <li><a href="views/auth/login.php">Iniciar sesión</a></li>
            <li><a href="views/propiedades/mapa.php">Mapa interactivo</a></li>
            <li><a href="#vendedores">Ver vendedores</a></li>
            <li><a href="#como-funciona">Cómo funciona</a></li>
          </ul>
        </div>

        <!-- ── Contacto (Mantiene el estilo premium) ── -->
          ...
          <div class="contact-items">
            ...
            <div class="contact-item">
              ...
              <div class="contact-info">
                ...
                <span class="contact-value">San Salvador, El Salvador</span>
              </div>
            </div>
            ...
            <div class="contact-item">
              ...
              <div class="contact-info">
                ...
                <span class="contact-value"><a href="tel:+50322223333">+503 2222-3333</a></span>
              </div>
            </div>
            ...
            <div class="contact-item">
              ...
              <div class="contact-info">
                ...
                <span class="contact-value">Lun – Vie: 8:00am – 5:00pm</span>
              </div>
            </div>
  ...
  <div class="footer-bottom">
    <div class="container">
      <div class="footer-bottom-inner">
        <p class="footer-copy">
          &copy; <?= date('Y') ?> <strong>Asociaciones PP.</strong>. Todos los derechos reservados.
        </p>
