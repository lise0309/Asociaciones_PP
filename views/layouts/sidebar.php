...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav" aria-label="Menú principal">
    ...
    <a href="dashboardadmin.php"
       class="sidebar-link <?= $pagina === 'dashboard.php' ? 'active' : '' ?>">
    ...
    <a href="usuarios.php"
       class="sidebar-link <?= $pagina === 'usuarios.php' ? 'active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
      ...
      Usuarios
      <span class="sidebar-badge" id="badgeUsuarios">142</span>
    </a>

    <a href="propiedades.php"
       class="sidebar-link <?= $pagina === 'propiedades.php' ? 'active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        <path fill-rule="evenodd" d="M9.293 2.293a1 1 0 011.414 0l7 7A1 1 0 0117 11h-1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-3a1 1 0 00-1-1H9a1 1 0 00-1 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-6H3a1 1 0 01-.707-1.707l7-7z" clip-rule="evenodd"/>
      </svg>
      Propiedades
      <span class="sidebar-badge" id="badgePropiedades">868</span>
    </a>

    <a href="contratos.php"
       class="sidebar-link <?= $pagina === 'contratos.php' ? 'active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd"/>
      </svg>
      Contratos
      <span class="sidebar-badge sidebar-badge-gold" id="badgeContratos">48</span>
    </a>

    <a href="plantillas.php"
       class="sidebar-link <?= $pagina === 'plantillas.php' ? 'active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    ...
    <a href="reportes.php"
       class="sidebar-link <?= $pagina === 'reportes.php' ? 'active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    ...
    <a href="configuracion.php"
       class="sidebar-link <?= $pagina === 'configuracion.php' ? 'active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    ...
    <a href="Mis_Propiedades.php"
       class="sidebar-link <?= $pagina === 'Mis_Propiedades.php' ? 'active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        <path fill-rule="evenodd" d="M9.293 2.293a1 1 0 011.414 0l7 7A1 1 0 0117 11h-1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-3a1 1 0 00-1-1H9a1 1 0 00-1 1v3a1 1 0 01-1 1H5a1 1 0 01-1-1v-6H3a1 1 0 01-.707-1.707l7-7z" clip-rule="evenodd"/>
      </svg>
      Mis propiedades
 ...
 <a href="propiedad_form.php"
  ...
  Nueva propiedad
    ...
    <a href="consultas.php"
       class="sidebar-link <?= $pagina === 'consultas.php' ? 'active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
      ...
      Consultas
      <span class="sidebar-badge sidebar-badge-gold" id="badgeConsultas">3</span>
    </a>

    <div class="sidebar-section-label">Documentos</div>

    <a href="contratosvendedor.php"
       class="sidebar-link <?= $pagina === 'contratos.php' ? 'active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd"/>
      </svg>
