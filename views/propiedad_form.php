    ...
    <div class="panel-main">
        ...
        <div class="panel-content">
            <div class="form-propiedad">
                ...
                <!-- FORM -->
                <form id="propiedadForm" method="POST"
                    ...
                    <div class="two-columns">
                        ...
                        <div class="col-left">
                            ...
                            <div class="form-section">
                                ...
                                <div class="section-body">
                                    <div class="form-group">
                                        <label><i class="fas fa-heading"></i> Nombre del anuncio <span class="required">*</span></label>
                                    ...
                                    <div class="form-row-2">
                                        <div class="form-group">
                                            <label><i class="fas fa-building"></i> Tipo de inmueble <span class="required">*</span></label>
                                    ...
                                    <div class="form-row-2">
                                        <div class="form-group">
                                            <label><i class="fas fa-dollar-sign"></i> Precio (USD) <span class="required">*</span></label>
                                            <input type="number" class="form-control" id="precio" name="precio"
                                                   value="<?= htmlspecialchars($propiedad['precio_pedido'] ?? '') ?>"
                                                   step="0.01" min="0" placeholder="298000" required>
                                        </div>
                                        <div class="form-group">
                                            <label><i class="fas fa-home"></i> Estado del inmueble</label>
                                    ...
                                    <div class="form-group">
                                        <label><i class="fas fa-align-left"></i> Descripción <span class="required">*</span></label>
                            ...
                            <div class="form-section">
                                <div class="section-title">
                                    <span><i class="fas fa-images"></i> Fotografías</span>
                                    <span class="section-action" id="btnReordenar">
                                        <i class="fas fa-arrows-alt"></i> Reordenar
                                    </span>
                                </div>
                                <div class="section-body">
                                    <div id="fotosGrid" class="fotos-grid">
                                        ...
                                        <div class="foto-item <?= $foto['es_foto_portada'] ? 'is-portada' : '' ?>"
                                            ...
                                            <?php if ($foto['es_foto_portada']): ?>
                                                <div class="foto-badge"><i class="fas fa-star"></i> Principal</div>
                                            <?php endif; ?>
                                    ...
                                    <p class="foto-hint">
                                        <i class="fas fa-info-circle"></i>
                                        Arrastra para reordenar · La primera foto será la portada · Máx. 20 fotos
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-right">
                            ...
                            <div class="form-section">
                                ...
                                <div class="section-body">
                                    <div class="form-row-2">
                                        <div class="form-group">
                                            <label><i class="fas fa-map"></i> Departamento <span class="required">*</span></label>
                                            <select class="form-control" id="departamento" name="departamento" required>
                                                <option value="">Seleccionar...</option>
                                                <?php foreach ($departamentos as $dep): ?>
                                                <option value="<?= $dep ?>" <?= (($propiedad['departamento'] ?? '') == $dep) ? 'selected' : '' ?>><?= $dep ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label><i class="fas fa-city"></i> Municipio <span class="required">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label><i class="fas fa-road"></i> Dirección exacta <span class="required">*</span></label>
                                        <input type="text" class="form-control" id="direccion" name="direccion"
                                               value="<?= htmlspecialchars($propiedad['direccion_exacta'] ?? '') ?>"
                                               placeholder="Km 32, carretera a Jayaque" required>
                                    </div>
                                    <div class="mapa-preview <?= ($propiedad['latitud'] ?? '') ? 'tiene-coords' : '' ?>" id="mapaPreview">
                                        <div class="mapa-inner">
                                            <i class="fas fa-map-marker-alt mapa-icon"></i>
                                            ...
                                            <small id="coordenadasTexto">
                                                ...
                                                <?php else: ?>
                                                    <i class="fas fa-mouse-pointer"></i> Haz clic para abrir el mapa
                                                <?php endif; ?>
                                            </small>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label><i class="fas fa-thumbtack"></i> Punto de referencia</label>
                            ...
                            <div class="form-section">
                                <div class="section-title">
                                    <span><i class="fas fa-ruler-combined"></i> Medidas y características</span>
                                </div>
                                <div class="section-body">
                                    <div class="form-row-3">
                                        <div class="form-group">
                                            <label><i class="fas fa-bed"></i> Habitaciones</label>
                                        ...
                                        <div class="form-group">
                                            <label><i class="fas fa-car"></i> Parqueos</label>
                                    ...
                                    <div class="form-row-2">
                                        <div class="form-group">
                                            <label><i class="fas fa-drafting-compass"></i> M² construcción</label>
                                            <input type="number" class="form-control" name="metros_construccion"
                                                   value="<?= $propiedad['metros_construccion'] ?? '' ?>"
                                                   step="0.01" placeholder="0.00">
                                        </div>
                                        <div class="form-group">
                                            <label><i class="fas fa-expand-arrows-alt"></i> M² terreno</label>
                                    ...
                                    <div class="form-group">
                                        <label><i class="fas fa-plus-circle"></i> Comodidades extras</label>
                                        <div class="check-group">
                                            ...
                                            <label class="check-option">
                                                ...
                                                <span><i class="fas fa-couch"></i> Amueblado</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-section">
                                <div class="section-title">
                                    <span><i class="fas fa-cog"></i> Configuración de publicación</span>
                                </div>
                                <div class="section-body">
                                    <div class="form-group">
                                        ...
                                        <div class="toggle-group">
                                            ...
                                            <label class="toggle-option">
                                                ...
                                                <span><i class="fas fa-lock"></i> Privada</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label><i class="fas fa-star"></i> Destacar anuncio</label>
                                        <div class="toggle-group">
                                            <label class="toggle-option">
                                                <input type="radio" name="destacar_radio" value="1"
                                                    <?= ($propiedad['es_anuncio_destacado'] ?? 0) ? 'checked' : '' ?>>
                                                <span><i class="fas fa-star"></i> Sí, destacar</span>
                                            </label>
                                            <label class="toggle-option">
                                                <input type="radio" name="destacar_radio" value="0"
                                                    <?= !($propiedad['es_anuncio_destacado'] ?? 0) ? 'checked' : '' ?>>
                                                <span><i class="far fa-star"></i> No destacar</span>
                                            </label>
                                        </div>
                                        ...
                                        <p class="field-hint">
                                            <i class="fas fa-info-circle"></i>
                                            Las propiedades destacadas aparecen primero en el inicio
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn-primary" id="btnGuardar">
                            <i class="fas fa-<?= $es_edicion ? 'save' : 'paper-plane' ?>"></i>
...
<div class="modal-overlay" id="modalMapaOverlay">
    <div class="modal-mapa">
        <div class="modal-header">
            <h3><i class="fas fa-map-marked-alt" style="color:var(--gold);margin-right:8px;"></i>Seleccionar ubicación</h3>
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn-secondary" id="btnCerrarMapa">
                <i class="fas fa-times"></i> Cancelar
            </button>
